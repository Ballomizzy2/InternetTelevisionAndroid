...
class ChannelFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        for (i in channels) {
            ...
            val linearLayout = view.findViewById<LinearLayout>(R.id.bottom)
        ...
        if (view is Button) {
            ...
            for (i in ChannelFragment.channels) {
                if (i.getLetters() == text) {
                    ...
                    /*val navController = Navigation.findNavController(MainActivity.getInstance(), R.id.fragmentContainerView)
